...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Game.prototype, "aboutGame", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: 'qweeqw' }),
    __metadata("design:type", String)
], Game.prototype, "img", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)(),
    __metadata("design:type", String)
], Game.prototype, "createdDate", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => rating_entity_1.Rating, (rating) => rating.game),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", rating_entity_1.Rating)
], Game.prototype, "rating", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => developer_entity_1.Developer, (developer) => developer.game),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", developer_entity_1.Developer)
], Game.prototype, "developer", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => comment_entity_1.Comment, (comment) => comment.game),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Array)
], Game.prototype, "comment", void 0);
Game = __decorate([
    (0, typeorm_1.Entity)()
], Game);
exports.Game = Game;
